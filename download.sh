...
clear
sleep 2
xdg-open http://Instagram.com/Banyuwangi_Cyber_Team
...
echo
    sleep 2
    echo $cyan":::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
    echo $cyan"::"$yellow"          AUTHOR"$cyan" :"$yellow" Rere.id~Queen-Caca           "$cyan"::"
    echo $cyan"::"$yellow"          TEAM  "$cyan" :"$yellow" BANYUWANGI CYBER TEAM     "$cyan"::"
    echo $cyan"::"$yellow"          IG    "$cyan" :"$yellow" Banyuwangi_Cyber_Team                      "$cyan"::"
    echo $cyan":::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
    echo
sleep 1
...
then
    ...
    sleep 1
    echo $cyan"SALAM Rere.id~Queen-Caca"
        exit
fi
